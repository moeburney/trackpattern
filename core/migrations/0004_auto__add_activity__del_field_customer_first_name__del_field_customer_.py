...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_activity', (
            ...
            ('activity_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('activity_desc', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('core', ['Activity'])

        # Deleting field 'Customer.first_name'
        db.delete_column('core_customer', 'first_name')

        # Deleting field 'Customer.last_name'
        db.delete_column('core_customer', 'last_name')

        # Adding field 'Customer.full_name'
        db.add_column('core_customer', 'full_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('core_customer', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Adding field 'Customer.last_name'
        db.add_column('core_customer', 'last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Deleting field 'Customer.full_name'
        db.delete_column('core_customer', 'full_name')
    ...
    models = {
        ...
        'core.activity': {
            'Meta': {'ordering': "['activity_date']", 'object_name': 'Activity'},
            'activity_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'activity_desc': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'core.campaign': {
            'Meta': {'ordering': "['campaign_name', 'start_date']", 'object_name': 'Campaign'},
            'campaign_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.category': {
            ...
            'characteristics': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        'core.customer': {
            'Meta': {'ordering': "['full_name']", 'object_name': 'Customer'},
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'company_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'connection': ('django.db.models.fields.SmallIntegerField', [], {'default': '2'}),
            'country': ('django.db.models.fields.CharField', [], {'max_length': '75', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'full_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
        ...
        'core.product': {
            ...
            'current_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
        ...
        'core.sale': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'marketing_source': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Campaign']", 'null': 'True', 'blank': 'True'}),
