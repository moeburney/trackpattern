...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column('core_customer', 'full_name',
            self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('core_customer', 'first_name',
            self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Adding field 'Customer.last_name'
        db.add_column('core_customer', 'last_name',
            self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)
    ...
    models = {
        ...
        'core.sale': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'marketing_source': ('django.db.models.fields.related.ForeignKey', [],
                                     {'to': "orm['core.Campaign']", 'null': 'True', 'blank': 'True'}),
            'price': (
            'django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
